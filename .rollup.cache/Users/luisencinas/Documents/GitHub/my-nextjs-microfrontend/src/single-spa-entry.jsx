...
const lifecycles = singleSpaReact({
    ...
    ReactDOM: ReactDOM, // Or just `ReactDOM` if your TS config allows it
    rootComponent: AppRoot,
    domElementGetter: () => document.getElementById("single-spa-application-container"),
...
//# sourceMappingURL=single-spa-entry.jsx.map